...
<!--[if (gte IE 9)|(gt IEMobile 7)]><!--><html class="no-js" <?php print $html_attributes . $rdf_namespaces; ?>><!--<![endif]-->
  ...
  <head profile="<?php print $grddl_profile; ?>">
    ...
    <?php elseif ($add_html5_shim): ?>
      ...
      <![endif]-->
    <?php endif; ?>
      <!--[if IE 8]><link href='<?php print $bas . path_to_theme();  ?>/css/Ie8.css' rel='stylesheet' type='text/css'><![endif]-->
    <!--[if gte IE 9]>
  <style type="text/css">
    .gradient {
       filter: none;
...
<link href='https://fonts.googleapis.com/css?family=Lato:400,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>-->
  ...
  <body class="<?php print $classes; ?>" <?php print $attributes; ?>>
    ...
    <style type="text/css">
@import "https://fonts.googleapis.com/css?family=Lato:400,300,300italic,400italic,700,700italic,900,900italic"
</style>
  </body>
</html>
